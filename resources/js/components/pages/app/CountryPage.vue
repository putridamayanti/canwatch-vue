                    ...
                    <v-flex xs12>
                        <v-card class="card-blue">
                            <v-toolbar class="card-header">
                                <v-toolbar-title class="white--text">Countries</v-toolbar-title>
                                <v-spacer></v-spacer>
...
<script>
    ...
    export default {
        ...
        methods: {
            async fetch() {
                let response    = await country.index();
            ...
            async openModal(id) {
                ...
                this.form = {};
                if (id) {
                    let response = await country.edit(id);
            ...
            async submit() {
                ...
                let response = [];
                if (this.form.id) {
                    response = await country.update(this.form.id, this.form)
                } else {
                    response = await country.store(this.form)
                }
            ...
            async remove(id) {
                ...
                let response = await country.delete(id);
                console.log(response);
                if (response.data.status) {
